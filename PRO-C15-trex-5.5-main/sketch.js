...
function preload(){
  trex_running = loadAnimation("i18.png","i19.png");
  trex_collided = loadAnimation("muerto.png");
  
  groundImage = loadImage("ground2.png");
  cloudImage = loadImage("cloud.png");
  obstacle1 = loadImage("z.jpg");
  obstacle2 = loadImage("slender (1).png");
  obstacle3 = loadImage("chi.png");
  obstacle4 = loadImage("obstacle4.png");
  obstacle5 = loadImage("obstacle5.png");
  obstacle6 = loadImage("obstacle6.png");
  restartImg = loadImage("restart.png");
  gameOverImg = loadImage("gameOver.png");
  //metal = loadSound("citynigths.mp3");
}

function setup() {
  createCanvas(600, 200);
  
  trex = createSprite(60,190,20,50);
